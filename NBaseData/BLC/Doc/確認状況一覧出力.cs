        ...
        public byte[] 確認状況一覧取得(MsUser loginUser, List<状況確認一覧Row> 状況確認一覧Rows)
        {
            ...
            using (ExcelCreator.Xlsx.XlsxCreator xls = new ExcelCreator.Xlsx.XlsxCreator())
            {
                ...
                foreach (状況確認一覧Row data in 状況確認一覧Rows)
                {
                    ...
                    List<DmKoukaiSaki> dmKoukaisakis = DmKoukaiSaki.GetRecordsByLinkSakiID(loginUser, linkSakiId);
                    ...
                    //                select p;
                    //write確認状況(xls, 安全運航海技Ｔ日付Cell, 安全運航海技Ｔ氏名Cell, 要確認, 安全運航海技Ｔs, dmComments);
                    //if (MaxRow < Row)
                    //{
                    //    MaxRow = Row;
                    //}
                    ...
                    //                 where p.DocFlag_Admin == (int)NBaseData.DS.DocConstants.FlagEnum.ON
                    ...
                    //           orderby p.DocFlag_GL descending, p.DocFlag_TL descending, p.KakuninDate ascending
                    //           select p;
                    //write確認状況(xls, 船員Ｔ日付Cell, 船員Ｔ氏名Cell, 要確認, 船舶管理技術Ｔs, dmComments);
                    //if (MaxRow < Row)
                    //{
                    //    MaxRow = Row;
                    //}
                    ...
                    //           orderby p.DocFlag_GL descending, p.DocFlag_TL descending, p.KakuninDate ascending
                    //           select p;
                    //write確認状況(xls, 船舶管理技術Ｔ日付Cell, 船舶管理技術Ｔ氏名Cell, 要確認, 船員Ｔs, dmComments);
                    //if (MaxRow < Row)
                    //{
                    //    MaxRow = Row;
                    //}
