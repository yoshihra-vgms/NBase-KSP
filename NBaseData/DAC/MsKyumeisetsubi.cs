...
{
    [DataContract()]
    [TableAttribute("MS_KYUMEISETUBI")]
    public class MsKyumeisetsubi
    {
        //MS_KYUMEISETUBI_ID             NVARCHAR2(40) NOT NULL,
        //MS_KYUMEISETUBI_NAME           NVARCHAR2(40),
        //KANKAKU                        NUMBER(9,0),
        ...
        {
            return this.MsKyumeisetsubiName;
        }

        public static List<MsKyumeisetsubi> GetRecords(MsUser loginUser)
        {
            string SQL = SqlMapper.SqlMapper.GetSql(typeof(MsKyumeisetsubi), MethodBase.GetCurrentMethod());
            List<MsKyumeisetsubi> ret = new List<MsKyumeisetsubi>();
            ParameterConnection Params = new ParameterConnection();
            MappingBase<MsKyumeisetsubi> mapping = new MappingBase<MsKyumeisetsubi>();
            ret = mapping.FillRecrods(loginUser.MsUserID, SQL, Params);

            return ret;
        }

        public static List<MsKyumeisetsubi> GetRecordsByName(MsUser loginUser,string Name)
        {
            string SQL = SqlMapper.SqlMapper.GetSql(typeof(MsKyumeisetsubi), "GetRecords") + System.Environment.NewLine;
            SQL += SqlMapper.SqlMapper.GetSql(typeof(MsKyumeisetsubi), "ByName");
        ...
        public static MsKyumeisetsubi GetRecord(MsUser loginUser, string ms_kyumei_id)
        {
            string SQL = SqlMapper.SqlMapper.GetSql(typeof(MsKyumeisetsubi), MethodBase.GetCurrentMethod());
            List<MsKyumeisetsubi> ret = new List<MsKyumeisetsubi>();
            ParameterConnection Params = new ParameterConnection();
        ...
        public bool InsertRecord(MsUser loginUser)
        {
            ...
            Params.Add(new DBParameter("MS_KYUMEISETUBI_NAME", this.MsKyumeisetsubiName));
