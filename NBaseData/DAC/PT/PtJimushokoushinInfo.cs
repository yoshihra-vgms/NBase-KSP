...
{
    [DataContract()]
    [TableAttribute("PT_JIMUSHOKOUSHIN_INFO")]
    public class PtJimushokoushinInfo : ISyncTableDoc
    {
        #region データメンバ
        ...
        /// </summary>
        [DataMember]
        [ColumnAttribute("PT_JIMUSHOKOUSHIN_INFO_ID", true)]
        public string PtJimushokoushinInfoId { get; set; }
        ...
        /// </summary>
        [DataMember]
        [ColumnAttribute("JIMUSHOKOUSHIN_INFO_USER")]
        ...
        /// </summary>
        [DataMember]
        [ColumnAttribute("JIMUSHOKOUSHIN_INFO_USER_NAME")]
        public string HonsenkoushinInfoUserName { get; set; }
 
        #endregion

        public PtJimushokoushinInfo()
        {
        }

        public static List<PtJimushokoushinInfo> GetRecords(NBaseData.DAC.MsUser loginUser)
        {
            string SQL = SqlMapper.SqlMapper.GetSql(typeof(PtJimushokoushinInfo), MethodBase.GetCurrentMethod());
            List<PtJimushokoushinInfo> ret = new List<PtJimushokoushinInfo>();
            ParameterConnection Params = new ParameterConnection();
            MappingBase<PtJimushokoushinInfo> mapping = new MappingBase<PtJimushokoushinInfo>();
            ret = mapping.FillRecrods(loginUser.MsUserID, SQL, Params);

            return ret;
        }

        public static List<PtJimushokoushinInfo> GetRecordsByCondition(NBaseData.DAC.MsUser loginUser, PtJimushokoushinInfoCondition condition)
        {
            string SQL = SqlMapper.SqlMapper.GetSql(typeof(PtJimushokoushinInfo), "GetRecords");

            // 期間
            SQL += " " + SqlMapper.SqlMapper.GetSql(typeof(PtJimushokoushinInfo), "ByEventDate");
            ...
            if (condition.Vessel_list.Count > 0)
            {
                ...
                foreach (int vessel in condition.Vessel_list)
                {
                    ...
                    SQL += " PT_JIMUSHOKOUSHIN_INFO.MS_VESSEL_ID = " + vessel;
                    num++;
                }
                SQL += ") ";
            }
            ...
            SQL += " " + SqlMapper.SqlMapper.GetSql(typeof(PtJimushokoushinInfo), "OrderByEventDateDesc");
        ...
        public static List<PtJimushokoushinInfo> GetRecordsBySanshoumotoId(NBaseData.DAC.MsUser loginUser, string id)
        {
            return GetRecordsBySanshoumotoId(null, loginUser, id);
        }


        public static List<PtJimushokoushinInfo> GetRecordsBySanshoumotoId(DBConnect dbConnect, MsUser loginUser, string id)
        {
            string SQL = SqlMapper.SqlMapper.GetSql(typeof(PtJimushokoushinInfo), "GetRecords");
            SQL += SqlMapper.SqlMapper.GetSql(typeof(PtJimushokoushinInfo), "BySanshoumotoId");
        ...
        public bool InsertRecord(DBConnect dbcone, NBaseData.DAC.MsUser loginUser)
        {
            ...
            int cnt = 0;
            ParameterConnection Params = new ParameterConnection();
            Params.Add(new DBParameter("PT_JIMUSHOKOUSHIN_INFO_ID", PtJimushokoushinInfoId));
            ...
            Params.Add(new DBParameter("JIMUSHOKOUSHIN_INFO_USER", HonsenkoushinInfoUser));
        ...
        public bool Exists(DBConnect dbcone, MsUser loginUser)
        {
            ...
            ParameterConnection Params = new ParameterConnection();
            Params.Add(new DBParameter("PK", PtJimushokoushinInfoId));
    ...
    [DataContract()]
    public class PtJimushokoushinInfoCondition
    {
        /// <summary>
        /// 日付From
        /// </summary>
        ...
        public PtJimushokoushinInfoCondition()
        {
