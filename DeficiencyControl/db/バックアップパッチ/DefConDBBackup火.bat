::火曜日用DeficiecnyControlバックアップスクリプト
...
::バックアップ
pg_dump.exe -h 192.168.245.33 -U "postgres" --encoding UTF8 --no-password -p 5432 -Fc -v defcondb > C:\DeficiencyControlBackUp\DefConDB_Tuesday.backup
