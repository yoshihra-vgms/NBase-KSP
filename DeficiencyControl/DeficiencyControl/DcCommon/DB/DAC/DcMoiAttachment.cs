...
namespace DcCommon.DB.DAC
{
    ...
    /// dc_moi_attachment
    /// </summary>
    public class DcMoiAttachment : BaseDac
    {
        public override int TableID
        {
            get
            {
                return DBTableID.dc_moi_attachment;
            }
        }
...
";
            ...
            {
                throw new Exception("DcMoiAttachment InsertRecord", e);
            }
        ...
        public override bool DeleteRecord(Npgsql.NpgsqlConnection cone, MsUser requser)
        {
            ...
            try
            {
                ret = this.ExecuteDelete(cone, requser, "dc_moi_attachment", "moi_id", this.moi_id, "attachment_id", this.attachment_id);
            }
            catch (Exception e)
            {
                throw new Exception("DcMoiAttachment DeleteRecord", e);
            }
