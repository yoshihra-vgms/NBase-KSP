...
namespace DcCommon.DB.DAC
{
    ...
    /// dc_schedule_company
    /// </summary>
    public class DcScheduleCompany : DcSchedule
    {
        public override int TableID
        {
            get
            {
                return DBTableID.dc_schedule_company;
            }
        }
...
SELECT
dc_schedule_company.schedule_id,
dc_schedule_company.schedule_category_id,
dc_schedule_company.schedule_kind_id,
dc_schedule_company.schedule_kind_detail_id,
dc_schedule_company.estimate_date,
dc_schedule_company.inspection_date,
dc_schedule_company.expiry_date,
dc_schedule_company.record_memo,
dc_schedule_company.color_r,
dc_schedule_company.color_g,
dc_schedule_company.color_b,

dc_schedule_company.delete_flag,
dc_schedule_company.create_ms_user_id,
dc_schedule_company.update_ms_user_id,
dc_schedule_company.create_date,
dc_schedule_company.update_date
...
";
        ...
        /// <returns></returns>
        public static List<DcScheduleCompany> GetRecordsBySearchData(NpgsqlConnection cone, ScheduleCompanySearchData sdata)
        {
...
WHERE
dc_schedule_company.delete_flag = false
";
                ...
                sql += @"
ORDER BY
dc_schedule_company.estimate_date DESC
";

                //SQL取得
                anslist = GetRecordsList<DcScheduleCompany>(cone, sql, paramlist);

            }
            catch (Exception e)
            {
                throw new Exception("DcScheduleCompany GetRecordsBySearchData", e);
            }
        ...
        public override int InsertRecord(NpgsqlConnection cone, MsUser requser)
        {
            ...
            {
                string sql = @"
INSERT INTO dc_schedule_company(
...
";
            ...
            {
                throw new Exception("DcScheduleCompany InsertRecord", e);
            }
...
";
            ...
            {
                throw new Exception("DcScheduleCompany UpdateRecord", e);
            }
        ...
        public override bool DeleteRecord(NpgsqlConnection cone, MsUser requser)
        {
            ...
            try
            {
                ret = this.ExecuteDelete(cone, requser, "dc_schedule_company", "schedule_id", this.schedule_id);
            }
            catch (Exception e)
            {
                throw new Exception("DcScheduleCompany DeleteRecord", e);
            }
