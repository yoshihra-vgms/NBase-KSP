...
namespace DcCommon.DB.DAC
{
    /// <summary>
    /// コメント親用添付ファイルテーブル 
    /// dc_comment_attachment
    /// </summary>    
    public class DcCommentAttachment : BaseDac
    {
        public override int TableID
        {
            get
            {
                return DBTableID.dc_comment_attachment;
            }
        }
        ...
        public override int InsertRecord(NpgsqlConnection cone, MsUser requser)
        {
            ...
            try
            {
                ...
                #region SQL
                string sql = @"
INSERT INTO dc_comment_attachment(
comment_id,
attachment_id,
...
";
            ...
            {
                throw new Exception("DcCommentAttachment InsertRecord", e);
            }
        ...
        public override bool DeleteRecord(Npgsql.NpgsqlConnection cone, MsUser requser)
        {
            ...
            try
            {
                ret = this.ExecuteDelete(cone, requser, "dc_comment_attachment", "comment_id", this.comment_id, "attachment_id", this.attachment_id);
            }
            catch (Exception e)
            {
                throw new Exception("DcCommentAttachment DeleteRecord", e);
            }
