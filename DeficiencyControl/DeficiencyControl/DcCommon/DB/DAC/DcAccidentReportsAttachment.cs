...
{
    /// <summary>
    /// 事故・トラブル報告書提出先添付ファイルテーブル
    /// </summary>
    public class DcAccidentReportsAttachment : BaseDac
    {
        public override int TableID
        {
            get
            {
                return DBTableID.dc_accident_reports_attachment;
            }
        }
        ...
        public override int InsertRecord(Npgsql.NpgsqlConnection cone, MsUser requser)
        {
            ...
            try
            {
                ...
                #region SQL
                string sql = @"
INSERT INTO dc_accident_reports_attachment(
accident_reports_id,
attachment_id,
...
";
            ...
            {
                throw new Exception("DcAccidentReportsAttachment InsertRecord", e);
            }
        ...
        public override bool DeleteRecord(Npgsql.NpgsqlConnection cone, MsUser requser)
        {
            ...
            try
            {
                ret = this.ExecuteDelete(cone, requser, "dc_accident_reports_attachment", "accident_reports_id", this.accident_reports_id, "attachment_id", this.attachment_id);
            }
            catch (Exception e)
            {
                throw new Exception("DcAccidentReportsAttachment DeleteRecord", e);
            }
