...
namespace DcCommon.DB.DAC
{
    /// <summary>
    /// Accident添付ファイルテーブル
    /// dc_accident_attachment
    /// </summary>
    public class DcAccidentAttachment : BaseDac
    {
        public override int TableID
        {
            get
            {
                return DBTableID.dc_accident_attachment;
            }
        }
        ...
        {   
            ...
            try
            {
                ...
                #region SQL
                string sql = @"
INSERT INTO dc_accident_attachment(
accident_id,
attachment_id,
...
";
            ...
            {
                throw new Exception("DcAccidentAttachment InsertRecord", e);
            }
        ...
        public override bool DeleteRecord(Npgsql.NpgsqlConnection cone, MsUser requser)
        {
            ...
            try
            {
                ret = this.ExecuteDelete(cone, requser, "dc_accident_attachment", "accident_id", this.accident_id, "attachment_id", this.attachment_id);
            }
            catch (Exception e)
            {
                throw new Exception("DcAccidentAttachment DeleteRecord", e);
            }
