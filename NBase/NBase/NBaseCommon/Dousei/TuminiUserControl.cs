...
{
    public partial class TuminiUserControl : UserControl
    {
        public enum ModeEnum { 積み, 揚げ } ;
        private DjDouseiCargo DouseiCargo = null;

        public TuminiUserControl(ModeEnum mode, int no)
        {
        ...
        public TuminiUserControl(ModeEnum mode, int no, List<MsCargo> msCargo_list, List<MsDjTani> msDjTani_list)
        {
            DouseiCargo = new DjDouseiCargo();
            Initialize(mode, no, msCargo_list, msDjTani_list);
        }
        ...
        public void ReadOnly()
        {
            ...
            label_1.Text = label_1.Text.Replace("　　", "");
            label_2.Text = label_2.Text.Replace("※ ", "");
            label_2.Text = label_2.Text.Replace("　　", "");
