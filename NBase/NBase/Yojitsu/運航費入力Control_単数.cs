...
namespace Yojitsu
{
    public partial class 運航費入力Control_単数 : UserControl
    {
        ...
        internal void SetData(BlobUnkouhi.Line2 line2)
        {
            this.line2 = line2;

            textBox単価.Text = line2.単価.ToString();
            textBox数量.Text = line2.数量.ToString();
        }
