...
namespace Yojitsu.util
{
	public partial class 経常収支管理表出力処理
	{
		...
		/// マイナスになったときの文字の色
		/// </summary>
		private static readonly System.Drawing.Color MinusFontColor = System.Drawing.Color.Red;
		...
		/// 経常収支templateファイル名
		/// </summary>
		private static readonly string 経常収支Templateファイル名 = "Template_経常収支実績.xls";
