...
namespace Yojitsu
{
    public partial class 予算対比表出力Form2 : Form
    {
        ...
        public 予算対比表出力Form2(List<BgYosanHead> yosanHeads)
        {
        ...
        private void InitComboBox予算種別()
        {
            ...
            foreach (BgYosanHead h in yosanHeads)
            {
                if (h.Year == Int32.Parse(comboBox年度.Text))
                {
                    ...
                    if (!comboBox予算種別2.Items.Contains(BgYosanSbt.ToName(h.YosanSbtID)))
                    {
                        comboBox予算種別2.Items.Add(BgYosanSbt.ToName(h.YosanSbtID));
                    }
                }
            }
            ...
            if (comboBox予算種別2.Items.Count > 0)
            {
                comboBox予算種別2.SelectedIndex = 0;
            }
        }
        ...
        private void InitComboBoxリビジョン()
        {
            ...
            foreach (BgYosanHead h in yosanHeads)
            {
                    ...
                    BgYosanSbt.ToName(h.YosanSbtID) == comboBox予算種別.Text)
                {
                    ...
                    comboBoxリビジョン2.Items.Add(revStr);
                }
            }
            ...
            if (comboBoxリビジョン2.Items.Count > 0)
            {
                comboBoxリビジョン2.SelectedIndex = 0;
            }
        }
        ...
        //                if (selectedIndex == 0)
        //                {
        //                    excelData = serviceClient.BLC_Excel月次収支報告書_取得_全社(NBaseCommon.Common.LoginUser,
        ...
        //                {
        //                    excelData = serviceClient.BLC_Excel月次収支報告書_取得_グループ(NBaseCommon.Common.LoginUser,
        //                       selectedYosanHead, unit,
        ...
        //                {
        //                    excelData = serviceClient.BLC_Excel月次収支報告書_取得_船(NBaseCommon.Common.LoginUser,
        //                       selectedYosanHead, unit,
