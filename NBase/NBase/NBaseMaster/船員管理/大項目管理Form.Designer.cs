namespace NBaseMaster.船員管理
{
    partial class 大項目管理Form
    {
        ...
        private void InitializeComponent()
        {
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.comboBox費用科目名);
			this.groupBox1.Controls.Add(this.label1);
			this.groupBox1.Controls.Add(this.buttonクリア);
			this.groupBox1.Controls.Add(this.button検索);
			this.groupBox1.Controls.Add(this.textBox大項目名);
			...
			this.textBox大項目名.Location = new System.Drawing.Point(101, 21);
			this.textBox大項目名.Name = "textBox大項目名";
			this.textBox大項目名.Size = new System.Drawing.Size(184, 19);
			this.textBox大項目名.TabIndex = 2;
			// 
			// label2
			// 
