...
{
    public partial class 基本給管理詳細Form2 : Form
    {
        ...
        private void 基本給管理詳細Form2_Load(object sender, EventArgs e)
        {
            label区分.Text = 基本給管理Common.Salary.Kind == (int)MsSiSalary.KIND.航機通砲手 ? "フェリー" : "内航";
            ...
            dt職務.Columns.Add(new DataColumn("0年", typeof(string)));
            dt職務.Columns.Add(new DataColumn("1年", typeof(string)));
            dt職務.Columns.Add(new DataColumn("2年", typeof(string)));
            dt職務.Columns.Add(new DataColumn("3年", typeof(string)));
            dt職務.Columns.Add(new DataColumn("4年", typeof(string)));
            dt職務.Columns.Add(new DataColumn("5年以上", typeof(string)));

            dataGridView職務.DataSource = dt職務;

            dataGridView職務.Columns[0].Width = 80;
            dataGridView職務.Columns[1].Width = 70;
            dataGridView職務.Columns[2].Width = 70;
            dataGridView職務.Columns[3].Width = 70;
            dataGridView職務.Columns[4].Width = 70;
            dataGridView職務.Columns[5].Width = 70;
            dataGridView職務.Columns[6].Width = 70;
            ...
            dataGridView職務.Columns[2].ReadOnly = true;
            dataGridView職務.Columns[2].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView職務.Columns[3].ReadOnly = true;
            dataGridView職務.Columns[3].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView職務.Columns[4].ReadOnly = true;
            dataGridView職務.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView職務.Columns[5].ReadOnly = true;
            dataGridView職務.Columns[5].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView職務.Columns[6].ReadOnly = true;
            dataGridView職務.Columns[6].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        {
            MsSiSalaryRank salaryRank = new MsSiSalaryRank();
            職務給Form2 form = new 職務給Form2(salaryRank);
            if (form.ShowDialog() == DialogResult.OK)
            {
                ...
                基本給管理Common.Salary.SalaryRankList.Add(salaryRank);
        ...
        private void 職務一覧表示()
        {
            ...
            if (基本給管理Common.Salary.SalaryRankList != null)
            {
                ...
                foreach (MsSiSalaryRank o in sortedList)
                {
                    ...
                    row[2] = 基本給管理Common.金額出力(o.Allowance1);
                    row[3] = 基本給管理Common.金額出力(o.Allowance2);
                    row[4] = 基本給管理Common.金額出力(o.Allowance3);
                    row[5] = 基本給管理Common.金額出力(o.Allowance4);
                    row[6] = 基本給管理Common.金額出力(o.Allowance5);
