...
namespace Dousei
{
    public partial class 内航海運輸送実績調査票Form : Form
    {
        public 内航海運輸送実績調査票Form()
        {
            InitializeComponent();
        }

        private void 内航海運輸送実績調査票Form_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            fd.Filter = 内航海運輸送実績調査票.TemplateName + " (*.xlsx)|*.xlsx";
            fd.FileName = 内航海運輸送実績調査票.TemplateName + ".xlsx";
            ...
            if (fd.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    //{
                    //    excelData = serviceClient.BLC_動静帳票_内航海運輸送実績調査票_取得(NBaseCommon.Common.LoginUser, DateMonth);
                    //}
