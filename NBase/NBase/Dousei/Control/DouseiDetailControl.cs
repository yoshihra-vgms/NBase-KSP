...
{
    public partial class DouseiDetailControl : UserControl
    {
        ...
        public string MsKanidouseiInfoShubetuID
        {
            get
            {
                return MsKanidouseiInfoShubetu.揚げID;
            }
        }
        ...
        public DouseiDetailControl()
        {
            InitializeComponent();
        }

        private void DouseiDetailControl_Load(object sender, EventArgs e)
        {
