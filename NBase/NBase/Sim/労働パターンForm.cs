...
namespace Sim
{
    public partial class 労働パターンForm : Form
    {
        ...
        private DateTime DefDateTime = new DateTime(2000, 1, 1);
        ...
        private void 労働パターンForm_Load(object sender, EventArgs e)
        {
            ...
            // イベントは、指定さ入れたイベント
            //comboBox_Event.SelectedIndex = EventIndex;
        ...
        private void SearchWorkPattern()
        {
            ...
            {
                //if ((comboBox_Event.SelectedItem as string) == "航海中")
                //    WorkPatternList = serviceClient.WorkPattern_GetRecords(NBaseCommon.Common.LoginUser, 0, Vessel.MsVesselID, null);
                //else if ((comboBox_Event.SelectedItem as string) == "停泊")
                //    WorkPatternList = serviceClient.WorkPattern_GetRecords(NBaseCommon.Common.LoginUser, 3, Vessel.MsVesselID, null);

                var eKind = comboBox_Event.SelectedItem as WorkPattern.WorkPatternEventKind;
                WorkPatternList = serviceClient.WorkPattern_GetRecords(NBaseCommon.Common.LoginUser, eKind.Kind, Vessel.MsVesselID, null);
            }
        ...
        private void comboBox_Event_SelectedValueChanged(object sender, EventArgs e)
        {
            //if (comboBox_Event.SelectedItem is string)
            //{
            //    if ((comboBox_Event.SelectedItem as string) == "航海中" || (comboBox_Event.SelectedItem as string) == "停泊")
            //    {
            //        EventIndex = comboBox_Event.SelectedIndex;
            ...
            //        form.EventIndex = comboBox_Event.SelectedIndex;
            //        form.Vessel = Vessel;
            //        form.Show();
            //    }
            //}
