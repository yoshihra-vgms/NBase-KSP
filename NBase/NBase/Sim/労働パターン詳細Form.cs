...
namespace Sim
{
    ...
    public partial class 労働パターン詳細Form : Form
    {
        ...
        public void SetAppointment(労働パターンForm_Appointment ap,  MsSiShokumei shoku, MsVessel ves, int eventKind)
        {
            Appointment = ap;
            Shokumei = shoku;
            Vessel = ves;
        ...
        private void button_OK_Click(object sender, EventArgs e)
        {
            ...
            DateTime dt1 = new DateTime(DefDateTime.Year, DefDateTime.Month, DefDateTime.Day, startH, startM,0);
            DateTime dt2 = new DateTime(DefDateTime.Year, DefDateTime.Month, DefDateTime.Day, endH, endM, 0);
