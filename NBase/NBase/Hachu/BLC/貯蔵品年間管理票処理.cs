...
namespace Hachu.BLC
{
    public class 貯蔵品年間管理票処理
    {
        ...
        {
            XlsCreator crea = new XlsCreator();
            uint id = 0;
            bool ret = false;
            ...
            //-----------------------------------------------------------
            ret = 貯蔵品年間管理票処理.LoadTemplateFile(ref crea, ref id, filename);
            if (ret == false)
            {
                return false;
            }
        ...
        private static void WriteVessel(ref XlsCreator crea, MsVessel msvessel)
        {
            //書き込み文字列作成
        ...
        private static void WritwGyousya(ref XlsCreator crea, string name)
        {
        ...
        /// <param name="crea"></param>
        /// <param name="year"></param>
        private static void WriteNengetsu(ref XlsCreator crea, int year)
        {
        ...
        private static void WriteItemData(ref XlsCreator crea, List<貯蔵品年間管理票まとめ> datalist)
        {
            int no = 1;
        ...
        private static void ConvertDataList(ref List<貯蔵品年間管理票まとめ> datalist,
            List<Chozo.貯蔵品TreeInfo> src, int kind, int month)
        {
            //期首残
            int startmonth = 4;
        ...
        //定数--------------------------------------------------
        //テンプレートファイル名
        const string TemplateFileName = "Template/貯蔵品年間管理票Template.xls";
