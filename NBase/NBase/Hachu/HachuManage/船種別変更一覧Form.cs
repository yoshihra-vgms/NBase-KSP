...
{
    public partial class 船種別変更一覧Form : Form
    {
        /// <summary>
        /// インスタンスを格納するフィールド変数
        /// </summary>
        private static 船種別変更一覧Form instance = null;

        /// <summary>
        /// 船種別変更情報リスト
        /// </summary>
        private 船種別変更一覧情報Controller 船種別変更一覧情報 = null;
        ...
        /// </summary>
        /// <returns></returns>
        public static 船種別変更一覧Form GetInstance()
        {
            if (instance == null)
            {
                instance = new 船種別変更一覧Form();
            }
            return instance;
        }
        ...
        {
            InitializeComponent();
            this.Text = NBaseCommon.Common.WindowTitle("JM040101", "船／種別変更一覧", ServiceReferences.WcfServiceWrapper.ConnectedServerID);
        }
        ...
        /// <param name="e"></param>
        #region private void 船種別変更一覧Form_Load(object sender, EventArgs e)
        private void 船種別変更一覧Form_Load(object sender, EventArgs e)
        {
            //==================================
            // 初期化
            //==================================
            ...
            船種別変更一覧情報 = new 船種別変更一覧情報Controller(this.MdiParent, splitContainer1, vslSyubHenkoListControl1);
            vslSyubHenkoListControl1.Init(this.Width + 100);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        #region private void 船種別変更一覧Form_FormClosing(object sender, FormClosingEventArgs e)
        private void 船種別変更一覧Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            船種別変更一覧情報.終了();
            instance = null;
        }
        ...
        private void button検索_Click(object sender, EventArgs e)
        {
            ...
            if (船種別変更一覧情報.検索結果数 == 0)
            {
                MessageBox.Show("対象データがありません。", "確認", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            //検索したらスクロールを一番下にする　2021/08/04 m.yoshihara
            vslSyubHenkoListControl1.MoveScrollbarLast();
        }
        #endregion
