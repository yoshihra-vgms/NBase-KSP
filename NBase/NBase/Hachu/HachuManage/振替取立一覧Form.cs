...
{
    public partial class 振替取立一覧Form : Form
    {
        /// <summary>
        /// インスタンスを格納するフィールド変数
        /// </summary>
        private static 振替取立一覧Form instance = null;

        /// <summary>
        /// 振替取立一覧情報リスト
        /// </summary>
        private 振替取立一覧情報Controller 振替取立一覧情報 = null;
        ...
        /// </summary>
        /// <returns></returns>
        public static 振替取立一覧Form GetInstance()
        {
            if (instance == null)
            {
                instance = new 振替取立一覧Form();
            }
            return instance;
        }
        ...
        {
            InitializeComponent();
            this.Text = NBaseCommon.Common.WindowTitle("JM041401", "取立・振替一覧", ServiceReferences.WcfServiceWrapper.ConnectedServerID);
        }
        ...
        /// <param name="e"></param>
        private void 振替取立一覧Form_Load(object sender, EventArgs e)
        {
            //==================================
            // 初期化
            //==================================
            ...
            振替取立一覧情報 = new 振替取立一覧情報Controller(this.MdiParent, treeListView振替取立一覧);
            振替取立一覧情報.初期化(this.Width - 20);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void 振替取立一覧Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            instance = null;
        }
        ...
        private void 検索条件初期化()
        {
            ...
            {
                if (sbt.MsThiIraiSbtID != NBaseCommon.Common.MsThiIraiSbt_燃料潤滑油ID)
                {
        ...
        private void button検索_Click(object sender, EventArgs e)
        {
            ...
            // 検索条件
            振替取立一覧検索条件 検索条件 = new 振替取立一覧検索条件();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        #region private void button追加_Click(object sender, EventArgs e)
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        #region private void treeListView振替取立一覧_DoubleClick(object sender, EventArgs e)
        private void treeListView振替取立一覧_DoubleClick(object sender, EventArgs e)
        {
            try
            {
