...
namespace NBaseHonsen.Document.BLC
{
    public class 回覧終了処理
    {
        ...
        public static bool Honsen登録(MsUser loginUser, DmKanryoInfo kanryoInfo)
        {
            bool ret = true;
            ...
            using (DBConnect dbConnect = new DBConnect())
            {
                ...
                ret = SyncTableSaver.InsertOrUpdate2(kanryoInfo, loginUser, StatusUtils.通信状況.未同期, dbConnect);
