...
namespace NBaseHonsen.Document
{
    public partial class コメント登録Form : ExForm
    {
        ...
        private void button_コメント登録_Click(object sender, EventArgs e)
        {
            ...
            bool ret = NBaseHonsen.Document.BLC.コメント登録処理.Honsen登録(同期Client.LOGIN_USER, DocComment, KanriKirokuFile, KoubunshoKisokuFile);
        ...
        private void FillInstance()
        {
            try
            {
                ...
                DocComment.MsUserID = 同期Client.LOGIN_USER.MsUserID;
