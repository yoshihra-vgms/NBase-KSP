...
namespace NBaseHonsen.BLC
{
    ...
    {        
        ...
        {
            ExcelCreator.Xlsx.XlsxCreator creator = new ExcelCreator.Xlsx.XlsxCreator();
            //ulong id = 0;//uint id = 0;// ExcelCreatorDLL置き換えによる関数対応 　
        ...
        /// <returns></returns>
        private static bool WriteDataMain(ref ExcelCreator.Xlsx.XlsxCreator crea,
            ...
            int year, int eyear, int smonth, int emonth, List<貯蔵品TreeInfo> datalist)
        {
            ...
            // 余分な行を削除する
            RemoveRows(ref crea, datalist.Count, addRows);
        ...
        /// <param name="crea"></param>
        /// <param name="kind"></param>
        private static void WriteShubetsu(ref ExcelCreator.Xlsx.XlsxCreator crea, int kind)
        {
            //名前を取得
        ...
        /// </summary>
        /// <returns></returns>
        private static void WriteVesselName(ref ExcelCreator.Xlsx.XlsxCreator crea, MsVessel msvessel)
        {
        ...
        /// <param name="sm"></param>
        /// <param name="em"></param>
        private static void WriteDate(ref ExcelCreator.Xlsx.XlsxCreator crea, int year, int eyear, int sm, int em)
        {
        ...
        /// <param name="crea"></param>
        /// <param name="datalist"></param>
        private static void WriteItemData(ref ExcelCreator.Xlsx.XlsxCreator crea, List<貯蔵品TreeInfo> datalist)
        {
            int i = 1;
        ...
        private static void WriteYosan(ref ExcelCreator.Xlsx.XlsxCreator crea, int kind, int yosan)
        {
            //潤滑油のときは予算を書く
        ...
        private static void RemoveRows(ref ExcelCreator.Xlsx.XlsxCreator crea, int dataCount, int addCount)
        {
            if (dataCount >= 100)
                return;
