    ...
    public partial class TeateUserControl : UserControl
    {
        ...
        public TeateUserControl(給与手当申請Form parentForm, MsUser loginUser, SeninTableCache seninTableCache, SiKyuyoTeate kyuyoTeate)
        {
            ...
            if (kyuyoTeate != null)
            {
                ...
                textBox4.Text = kyuyoTeate.HonsenKingaku != int.MinValue ? kyuyoTeate.HonsenKingaku.ToString("0") : "";
                //textBox4.Text = kyuyoTeate.Kingaku != int.MinValue ? kyuyoTeate.Kingaku.ToString("0") : "";  // Wing用
            }
            else
            {
